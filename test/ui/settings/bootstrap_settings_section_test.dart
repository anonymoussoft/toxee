...
void main() {
  ...
  group('BootstrapSettingsSection - desktop mode row', () {
    ...
    testWidgets(
      ...
      final manualRadio = find.byWidgetPredicate(
        (w) => w is RadioListTile<String> && w.value == 'manual',
      );
    ...
    testWidgets('seeded current node prefs surface as a current-node tile',
      ...
      expect(find.textContaining('bootstrap.example.com:33445'), findsOneWidget,
